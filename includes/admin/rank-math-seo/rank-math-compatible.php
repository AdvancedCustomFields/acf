...
/**
 * Adds ACF data to the content analyses of Rank Math SEO.
 */
class Rank_Math_SEO {
	...
	public function __construct() {
		acf_include('includes/admin/rank-math-seo/inc/requirements.php');
		...
		acf_include('includes/admin/rank-math-seo/inc/dependencies/dependency-interface.php');
		acf_include('includes/admin/rank-math-seo/inc/dependencies/dependency-rank-math-seo.php');
		acf_include('includes/admin/rank-math-seo/inc/dependencies/dependency-acf.php');
