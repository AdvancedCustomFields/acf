  ...
  class acf_field_color_picker extends acf_field
  {
    ...
    */
    ...
    function input_admin_enqueue_scripts()
    {
      ...
      wp_register_script( 'wp-color-picker-alpha', acf_get_url("/assets/inc/color-picker-alpha/wp-color-picker-alpha.min.js"), array( 'wp-color-picker' ), '2.1.3', true );
    ...
    */
    ...
    function render_field($field)
    {
      ...
      <div class="acf-color-picker">
        ...
        <input type="text" <?php echo acf_esc_attrs($text_input); ?> data-alpha="true"/>
      </div>
      <?php
    }
